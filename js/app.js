 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const feedbackSliders = document.querySelectorAll(".feedback__slider");
        if (feedbackSliders.length) feedbackSliders.forEach((feedbackSliders => {
            new Splide(feedbackSliders, {
                type: "loop",
                arrows: true,
                autoplay: true,
                pagination: false,
